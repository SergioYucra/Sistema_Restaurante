...
if(isset($_POST['actualizacion'])){
	...
	$orden = "UPDATE comida SET img_comida='$imagen' WHERE id_comida = $id";
...
<div class=" container" id='form'>
	<br>
	<!-- Formulario -->
	<form method="POST" action="edit_img.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
		
        <div class="form-row">
            
			<div class="form-group col-md-6 col-lg-6">
            <label for="">Imagen Actual</label> <br>
            <img src="data:image/jpg;base64,<?php echo base64_encode($row['img_comida']);?>" width="100%">
            </div>             
	   	</div>  
        <div class="form-row">
